...
if (!during_initial_install()) { //do not use during installation
    ...
    if ($hassiteconfig or has_any_capability(array(
        ...
        $temp->add(new admin_setting_courselist_frontpage(1)); // NEW •	Front page items for managers
        $temp->add(new admin_setting_courselist_frontpage(2)); // NEW •	Front page items for teachers
        $temp->add(new admin_setting_courselist_frontpage(3)); // NEW •	Front page items for students
        $temp->add(new admin_setting_courselist_frontpage(4)); // non-loggedin version of the setting (that's what the parameter is for :) )
        $temp->add(new admin_setting_courselist_frontpage(5));  // loggedin version of the setting
